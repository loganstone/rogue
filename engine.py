    ...
    while not libtcod.console_is_window_closed():
        ...
        if take_stairs and game_state == GameStates.PLAYERS_TURN:
            for entity in entities:
                ...
                message_log.add_message(Message(text, libtcod.yellow))
        ...
        for player_turn_result in player_turn_results:
            ...
            if equip:
                ...
                for equip_result in equip_results:
                    ...
                    if equipped:
                        text = 'You equipped the {0}'.format(equipped.name)
                        message_log.add_message(Message(text))

                    dequipped = equip_result.get('dequipped')
                    if dequipped:
                        text = 'You dequipped the {0}'.format(dequipped.name)
                        message_log.add_message(Message(text))
            ...
            if xp:
                ...
                if leveled_up:
                    text = ('Your battle skills grow stronger! '
